...
export const tasks = pgTable('tasks', {
  ...
  // Use z.coerce.date() to allow Zod to attempt parsing various string formats into a Date object.
  // Then make it nullable and optional to match your Drizzle schema.
  deadline: timestamp('deadline'), // Drizzle definition remains the same
  // ============================
...
// Insert schemas
// We need to override the deadline field specifically for the Zod schema generated by drizzle-zod
export const insertTaskSchema = createInsertSchema(tasks).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
}).extend({
  // Explicitly define deadline using z.coerce.date() for robust parsing
  // It needs to be nullable() because Drizzle's timestamp can be null
  // It needs to be optional() because it's not always provided in the form
...
export type InsertTask = z.infer<typeof insertTaskSchema>; // This type will now reflect the z.coerce.date()
